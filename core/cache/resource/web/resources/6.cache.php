<?php  return array (
  ...
  array (
    ...
    'isfolder' => 1,
    'introtext' => '',
    'content' => '<h3 class="content">Компенсаторы</h3>
        <div class="box-produce width-33 box1"><div><img src="images/catalog/silfonyi_compensatoryKSO.jpeg" alt="" /></div>
            <p><a class="uppercase" href="/produce/category-compensatory/silfonnye/">Сильфонные</a></h3></div>
        <div class="box-produce width-33 box2"><div><img src="images/catalog/kompensator-rezinoviy.jpg" alt="" /></div>
            <p><a class="uppercase" href="/produce/category-compensatory/rezinovye/">Резиновые</a></h3></div>
        <div class="box-produce width-33 box3"><div><img src="images/catalog/compr-Salnikovyi.png" alt="" /></div>
            <p><a class="uppercase" href="/produce/category-compensatory/salnikoviye/">Сальниковые</a></h3></div>
        <div class="box-produce width-33 box4"><div><img src="images/catalog/linzoviy-compensator.png" alt="" /></div>
            <p><a class="uppercase" href="/produce/category-compensatory/linzovye/">Линзовые</a></h3></div>
        <div class="box-produce width-33 box5"><div><img src="images/catalog/compensatorTkan.png" alt="" /></div>
            <p><a class="uppercase" href="/produce/category-compensatory/tkanevye">Тканевые</a></h3></div>
',
    'richtext' => 0,
    'template' => 9,
    'menuindex' => 5,
    ...
    'cacheable' => 1,
    'createdby' => 1,
    'createdon' => 1506072654,
    'editedby' => 1,
    'editedon' => 1507107008,
    'deleted' => 0,
    'deletedon' => 0,
    'deletedby' => 0,
    'publishedon' => 1506072600,
    'publishedby' => 1,
    'menutitle' => '',
    'donthit' => 0,
    'privateweb' => 0,
...
<div id="produce"><div class="leftbar content">
  ...
  /  <li class="B_lastCrumb" itemscope="itemscope" itemtype="http://data-vocabulary.org/Breadcrumb"><li itemscope="itemscope" class="B_currentCrumb" itemtype="http://data-vocabulary.org/Breadcrumb">Компенсаторы</li></li>
</ul><br/></div><div><h3 class="content">Компенсаторы</h3>
        <div class="box-produce width-33 box1"><div><img src="images/catalog/silfonyi_compensatoryKSO.jpeg" alt="" /></div>
            <p><a class="uppercase" href="/produce/category-compensatory/silfonnye/">Сильфонные</a></h3></div>
        <div class="box-produce width-33 box2"><div><img src="images/catalog/kompensator-rezinoviy.jpg" alt="" /></div>
            <p><a class="uppercase" href="/produce/category-compensatory/rezinovye/">Резиновые</a></h3></div>
  ...
  array (
    ...
    '[[*description]]' => '',
    '[[$?text=`Компенсаторы`]]' => '<li itemscope="itemscope" class="B_currentCrumb" itemtype="http://data-vocabulary.org/Breadcrumb">Компенсаторы</li>',
    '[[~3]]' => 'produce/',
    ...
    '[[$?text=`<li itemscope="itemscope" class="B_currentCrumb" itemtype="http://data-vocabulary.org/Breadcrumb">Компенсаторы</li>`]]' => '<li class="B_lastCrumb" itemscope="itemscope" itemtype="http://data-vocabulary.org/Breadcrumb"><li itemscope="itemscope" class="B_currentCrumb" itemtype="http://data-vocabulary.org/Breadcrumb">Компенсаторы</li></li>',
