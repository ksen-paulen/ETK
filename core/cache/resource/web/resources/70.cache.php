...
<ul>
<li>Относительно низкий вес и, как следствие, отсутствие необходимости применении специального установочного оборудования;</li>
<li>Гибкость вибровставок позволяет изделию восстанавливать форму после любых перемещений, деформация требует меньших усилий;</li>
<li>Натуральные и синтетические эластомеры не подвержены усталости, не становятся хрупкими и предотвращают любое электролитическое воздействие;</li>
<li>Теплопотери сокращаются, в то время как п-образные петли увеличивают потерю тепла;</li>
<li>Резиновые компенсаторы изготавливаются из различных типов эластомеров, каждый из которых подбирается в зависимости от условий эксплуатации и проводимой среды, что увеличивает срок службы компенсатора и повышает его устойчивость к коррозии, эрозии, абразивным материалам;</li>
<li>Не требует использования уплотнительных прокладок;</li>
<li>Значительно сокращают уровень вибрации и шума в трубопроводных системах, так как эластомерная составляющая компенсатора действует как демпфер;</li>
<li>Данный тип компенсаторов обладает хорошим сопротивлением к ударным нагрузкам, вызванным гидравлическим ударом, кавитацией в насосе.</li>
</ul>',
    'richtext' => 1,
    'template' => 7,
    'menuindex' => 4,
    ...
    'cacheable' => 1,
    'createdby' => 1,
    'createdon' => 1509378754,
    'editedby' => 0,
    'editedon' => 0,
    'deleted' => 0,
    'deletedon' => 0,
    'deletedby' => 0,
    'publishedon' => 1509378754,
    'publishedby' => 1,
    'menutitle' => '',
    'donthit' => 0,
    'privateweb' => 0,
...
<div class="content"><ul class="B_crumbBox"><li class="B_firstCrumb" itemscope="itemscope" itemtype="http://data-vocabulary.org/Breadcrumb"><a class="B_homeCrumb" itemprop="url" rel="Home" href="http://etk.system5.ru/"><span itemprop="title">Home</span></a></li>
  ...
  /  <li itemscope="itemscope" class="B_crumb" itemtype="http://data-vocabulary.org/Breadcrumb"><a class="B_crumb" itemprop="url" rel="Резиновые" href="produce/category-compensatory/rezinovye/"><span itemprop="title">Резиновые</span></a></li>
  /  <li class="B_lastCrumb" itemscope="itemscope" itemtype="http://data-vocabulary.org/Breadcrumb"><li itemscope="itemscope" class="B_currentCrumb" itemtype="http://data-vocabulary.org/Breadcrumb">Резиновые компенсаторы КРК 03</li></li>
</ul><br/><h3>Характеристики</h3>
<ul>
<li>Относительно низкий вес и, как следствие, отсутствие необходимости применении специального установочного оборудования;</li>
<li>Гибкость вибровставок позволяет изделию восстанавливать форму после любых перемещений, деформация требует меньших усилий;</li>
<li>Натуральные и синтетические эластомеры не подвержены усталости, не становятся хрупкими и предотвращают любое электролитическое воздействие;</li>
...
<div class="container-footer">
  ...
  array (
    ...
    '[[$?text=`Резиновые компенсаторы КРК 03`]]' => '<li itemscope="itemscope" class="B_currentCrumb" itemtype="http://data-vocabulary.org/Breadcrumb">Резиновые компенсаторы КРК 03</li>',
    '[[~4]]' => 'produce/category-compensatory/rezinovye/',
    '[[$?resource=`4`&description=`Резиновые`&text=`Резиновые`]]' => '<a class="B_crumb" itemprop="url" rel="Резиновые" href="produce/category-compensatory/rezinovye/"><span itemprop="title">Резиновые</span></a>',
    ...
    '[[$?text=`<a class="B_crumb" itemprop="url" rel="Резиновые" href="produce/category-compensatory/rezinovye/"><span itemprop="title">Резиновые</span></a>`]]' => '<li itemscope="itemscope" class="B_crumb" itemtype="http://data-vocabulary.org/Breadcrumb"><a class="B_crumb" itemprop="url" rel="Резиновые" href="produce/category-compensatory/rezinovye/"><span itemprop="title">Резиновые</span></a></li>',
    '[[$?text=`<li itemscope="itemscope" class="B_currentCrumb" itemtype="http://data-vocabulary.org/Breadcrumb">Резиновые компенсаторы КРК 03</li>`]]' => '<li class="B_lastCrumb" itemscope="itemscope" itemtype="http://data-vocabulary.org/Breadcrumb"><li itemscope="itemscope" class="B_currentCrumb" itemtype="http://data-vocabulary.org/Breadcrumb">Резиновые компенсаторы КРК 03</li></li>',
